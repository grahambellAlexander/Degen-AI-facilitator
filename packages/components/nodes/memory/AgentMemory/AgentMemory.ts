    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'string',
                placeholder: 'C:\\Users\\User\\.DegenAIfacilitator\\database.sqlite',
                description:
    ...
    async init(nodeData: INodeData, _: string, options: ICommonObject): Promise<any> {
        ...
        if (databaseType === 'sqlite') {
            datasourceOptions.database = databaseFilePath
                ...
                : path.join(process.env.DATABASE_PATH ?? path.join(getUserHome(), '.DegenAIfacilitator'), 'database.sqlite')
