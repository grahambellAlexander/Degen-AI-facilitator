        ...
        this.inputs = [
            {
                ...
                type: 'string',
                description:
                    'If not specified, a random id will be used. Learn <a target="_blank" href="https://docs.degenaifacilitator.site/memory/long-term-memory#ui-and-embedded-chat">more</a>',
                default: '',
